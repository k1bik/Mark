...
public class ViewPanel extends JPanel implements ActionListener {
    ...
    public ViewPanel(){
        ...
        JButton but4=new JButton ("Итог 1:  макс. цена для каждого типа вагона");
        JButton but5=new JButton ("Итог 2:  общее число поездов");
        JButton but6=new JButton ("Применить фильтр");
        JButton but7=new JButton ("Сортировать по номеру поезда и типу вагона");
        JButton but8=new JButton ("Сортировать по типу вагона и цене");
        JButton but9=new JButton ("Вывести все");
        tf=new JTextField("");
        JLabel l1 = new JLabel("Введите фильтр для билета",JLabel.CENTER);
    ...
    private void showTotal1(){
        TotalDialog td = new TotalDialog (MainFrame.frame,"Макс. цена для каждого типа вагона:",
                Global.table.totalMaxPriceOfTicket());
        td.setVisible(true); 
    }
    ...
    private void showTotal2(){
        ...
        JOptionPane.showMessageDialog(MainFrame.frame,
            String.format("Общее число поездов: %5d", Global.table.trainNumber()));
    }
    ...
    private void showFilter(){
        ...
        MainFrame.MSG.setText(String.format("Запрос на выборку: выдать записи с билетами, начинающейся с \"%s\"", filter));
        Global.updateJTable(Global.table.filterTypeOfTrain(filter).getResults());
        tf.setText("");
    }

    private void showSort1(){
        MainFrame.MSG.setText("Запрос на выборку: выдать все записи таблицы с сортировкой по номеру поезда и типу вагона");
        Global.updateJTable(Global.table.sort(new CompCommandAscBallDesc ()).getResults());    
    }

    private void showSort2(){
        MainFrame.MSG.setText("Запрос на выборку: выдать все записи таблицы с сортировкой по типу вагона и цене");
