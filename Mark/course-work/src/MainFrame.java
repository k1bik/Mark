...
public class MainFrame implements ActionListener{
    ...
    public   MainFrame(){
        Global.table = new ResultGroup("Список записей о ценах билетов на поезда");
        ...
        myC.add(new JLabel("Цены билетов на поезд", JLabel.CENTER), BorderLayout.NORTH);
    ...
    public void actionPerformed (ActionEvent e){
        if("Новый".equals(e.getActionCommand()))NewFile(); 
            ...
            HelpDialog helpMSG = new HelpDialog(MainFrame.frame,"О программе",helpArr1);
